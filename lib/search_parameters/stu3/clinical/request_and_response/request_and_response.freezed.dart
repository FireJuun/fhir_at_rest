...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'DeviceRequestSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, code: $code, identifier: $identifier, patient: $patient, encounter: $encounter, authoredOn: $authoredOn, basedOn: $basedOn, definition: $definition, device: $device, eventDate: $eventDate, groupIdentifier: $groupIdentifier, intent: $intent, performer: $performer, priorrequest: $priorrequest, requester: $requester, status: $status, subject: $subject)';
  }
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'CommunicationSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, basedOn: $basedOn, category: $category, context: $context, definition: $definition, encounter: $encounter, identifier: $identifier, medium: $medium, partOf: $partOf, patient: $patient, received: $received, recipient: $recipient, sender: $sender, sent: $sent, status: $status, subject: $subject)';
  }
