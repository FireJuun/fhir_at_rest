...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'EncounterSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, date: $date, identifier: $identifier, patient: $patient, type: $type, appointment: $appointment, class_: $class_, diagnosis: $diagnosis, episodeofcare: $episodeofcare, incomingreferral: $incomingreferral, length: $length, location: $location, locationPeriod: $locationPeriod, partOf: $partOf, participant: $participant, participantType: $participantType, practitioner: $practitioner, reason: $reason, serviceProvider: $serviceProvider, specialArrangement: $specialArrangement, status: $status, subject: $subject)';
  }
...
abstract class _LibrarySearch extends LibrarySearch {
  ...
  factory _LibrarySearch(
      ...
      List<SearchToken> topic,
      List<SearchUri> url,
      List<SearchToken> version}) = _$_LibrarySearch;
