...
// ignore: unused_element
  _PatientSearch call(
      ...
      @JsonKey(name: 'animal-breed')
          List<SearchToken> animalBreed,
      @JsonKey(name: 'animal-species')
          List<SearchToken> animalSpecies,
...
//List<SearchToken> searchType,
  ...
  @JsonKey(name: 'animal-breed')
  List<SearchToken> get animalBreed;
  @JsonKey(name: 'animal-species')
  List<SearchToken> get animalSpecies;
...
class _$PatientSearchCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      animalBreed: animalBreed == freezed
          ? _value.animalBreed
          : animalBreed as List<SearchToken>,
      animalSpecies: animalSpecies == freezed
          ? _value.animalSpecies
          : animalSpecies as List<SearchToken>,
...
class _$_PatientSearch extends _PatientSearch {
  _$_PatientSearch(
      ...
      @JsonKey(name: 'animal-breed') this.animalBreed,
      @JsonKey(name: 'animal-species') this.animalSpecies,
      this.birthdate,
...
//List<SearchToken> searchType,
  ...
  @override
  @JsonKey(name: 'animal-breed')
  final List<SearchToken> animalBreed;
  @override
  @JsonKey(name: 'animal-species')
  final List<SearchToken> animalSpecies;
  @override
    ...
    return identical(this, other) ||
        (other is _PatientSearch &&
            ...
            (identical(other.animalBreed, animalBreed) ||
                const DeepCollectionEquality()
                    .equals(other.animalBreed, animalBreed)) &&
            (identical(other.animalSpecies, animalSpecies) ||
                const DeepCollectionEquality()
                    .equals(other.animalSpecies, animalSpecies)) &&
            ...
            (identical(other.given, given) || const DeepCollectionEquality().equals(other.given, given)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(animalBreed) ^
      const DeepCollectionEquality().hash(animalSpecies) ^
...
abstract class _RelatedPersonSearch extends RelatedPersonSearch {
  ...
  factory _RelatedPersonSearch(
      ...
      List<SearchToken> identifier,
      List<SearchString> name,
      List<SearchReference> patient}) = _$_RelatedPersonSearch;
