...
_$_ServiceDefinitionSearch _$_$_ServiceDefinitionSearchFromJson(
    Map<String, dynamic> json) {
  return _$_ServiceDefinitionSearch(
    searchId: (json['searchId'] as List)
        ?.map((e) => e == null ? null : Id.fromJson(e as String))
        ?.toList(),
    searchLastUpdated: (json['searchLastUpdated'] as List)
...
Map<String, dynamic> _$_$_ServiceDefinitionSearchToJson(
    _$_ServiceDefinitionSearch instance) {
  final val = <String, dynamic>{};
