...
@freezed
abstract class DataElementSearch
    with Stu3SearchParameters
    implements _$DataElementSearch {
...
//List<SearchToken> searchType,
  ...
  DataElementSearch._();
  factory DataElementSearch.fromJson(Map<String, dynamic> json) =>
      _$DataElementSearchFromJson(json);
}
