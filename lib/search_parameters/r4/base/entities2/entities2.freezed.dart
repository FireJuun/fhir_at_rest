...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'DeviceSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, device_name: $device_name, identifier: $identifier, location: $location, manufacturer: $manufacturer, model: $model, organization: $organization, patient: $patient, status: $status, type: $type, udi_carrier: $udi_carrier, udi_di: $udi_di, url: $url)';
  }
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'DeviceMetricSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, category: $category, identifier: $identifier, parent: $parent, source: $source, type: $type)';
  }
...
//List<SearchToken> searchType,
  ...
  List<SearchToken> get status;
  List<String> get substance_reference;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      substance_reference: substance_reference == freezed
          ...
          : substance_reference as List<String>,
    ));
  }
}
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'SubstanceSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, category: $category, code: $code, container_identifier: $container_identifier, expiry: $expiry, identifier: $identifier, quantity: $quantity, status: $status, substance_reference: $substance_reference)';
  }
...
abstract class _SubstanceSearch extends SubstanceSearch {
  ...
  factory _SubstanceSearch(
      ...
      List<String> quantity,
      List<SearchToken> status,
      List<String> substance_reference}) = _$_SubstanceSearch;
