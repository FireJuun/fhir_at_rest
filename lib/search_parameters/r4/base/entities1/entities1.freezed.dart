...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'EndpointSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, connection_type: $connection_type, identifier: $identifier, name: $name, organization: $organization, payload_type: $payload_type, status: $status)';
  }
...
//List<SearchToken> searchType,
  ...
  @override
  final List<String> coverage_area;
  @override
  ...
  @override
  String toString() {
    return 'HealthcareServiceSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, active: $active, characteristic: $characteristic, coverage_area: $coverage_area, endpoint: $endpoint, identifier: $identifier, location: $location, name: $name, organization: $organization, program: $program, service_category: $service_category, service_type: $service_type, specialty: $specialty)';
  }
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      identifier: identifier == freezed
          ...
          : identifier as List<SearchToken>,
      name: name == freezed ? _value.name : name as List<SearchString>,
      near: near == freezed ? _value.near : near as List<String>,
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'LocationSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, address: $address, address_city: $address_city, address_country: $address_country, address_postalcode: $address_postalcode, address_state: $address_state, address_use: $address_use, endpoint: $endpoint, identifier: $identifier, name: $name, near: $near, operational_status: $operational_status, organization: $organization, partof: $partof, status: $status, type: $type)';
  }
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'OrganizationSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, active: $active, address: $address, address_city: $address_city, address_country: $address_country, address_postalcode: $address_postalcode, address_state: $address_state, address_use: $address_use, endpoint: $endpoint, identifier: $identifier, name: $name, partof: $partof, phonetic: $phonetic, type: $type)';
  }
...
//List<SearchToken> searchType,
  ...
  List<String> get participating_organization;
  List<SearchToken> get phone;
  List<String> get primary_organization;
...
class _$OrganizationAffiliationSearchCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      location:
          location == freezed ? _value.location : location as List<String>,
      network: network == freezed ? _value.network : network as List<String>,
      participating_organization: participating_organization == freezed
          ? _value.participating_organization
          : participating_organization as List<String>,
      ...
      primary_organization: primary_organization == freezed
          ...
          : primary_organization as List<String>,
...
//List<SearchToken> searchType,
  ...
  @override
  final List<String> participating_organization;
  @override
  final List<SearchToken> phone;
  @override
  final List<String> primary_organization;
  @override
  ...
  @override
  String toString() {
    return 'OrganizationAffiliationSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, active: $active, date: $date, email: $email, endpoint: $endpoint, identifier: $identifier, location: $location, network: $network, participating_organization: $participating_organization, phone: $phone, primary_organization: $primary_organization, role: $role, service: $service, specialty: $specialty, telecom: $telecom)';
  }
