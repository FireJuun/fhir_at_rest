...
class _$ClaimSearchCopyWithImpl<$Res> implements $ClaimSearchCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      insurer: insurer == freezed ? _value.insurer : insurer as List<String>,
      item_udi:
...
class _$ClaimResponseSearchCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      requestor:
          requestor == freezed ? _value.requestor : requestor as List<String>,
      status: status == freezed ? _value.status : status as List<SearchToken>,
      use: use == freezed ? _value.use : use as List<SearchToken>,
    ));
  }
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'ClaimResponseSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, created: $created, disposition: $disposition, identifier: $identifier, insurer: $insurer, outcome: $outcome, patient: $patient, payment_date: $payment_date, request: $request, requestor: $requestor, status: $status, use: $use)';
  }
...
//List<SearchToken> searchType,
  ...
  List<String> get totalgross;
  List<String> get totalnet;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      identifier: identifier == freezed
          ? _value.identifier
          : identifier as List<SearchToken>,
      issuer: issuer == freezed ? _value.issuer : issuer as List<String>,
      ...
      totalgross: totalgross == freezed
          ? _value.totalgross
          : totalgross as List<String>,
      totalnet:
          totalnet == freezed ? _value.totalnet : totalnet as List<String>,
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'InvoiceSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, account: $account, date: $date, identifier: $identifier, issuer: $issuer, participant: $participant, participant_role: $participant_role, patient: $patient, recipient: $recipient, status: $status, subject: $subject, totalgross: $totalgross, totalnet: $totalnet, type: $type)';
  }
