...
mixin _$CoverageSearch {
  ...
  List<String> get payor;
  List<String> get policy_holder;
  List<SearchToken> get status;
  List<String> get subscriber;
...
class _$_CoverageSearch extends _CoverageSearch {
  ...
  @override
  final List<String> payor;
  @override
  final List<String> policy_holder;
  @override
...
abstract class _EnrollmentRequestSearch extends EnrollmentRequestSearch {
  ...
  factory _EnrollmentRequestSearch(
      ...
      List<String> patient,
      List<SearchToken> status,
      List<String> subject}) = _$_EnrollmentRequestSearch;
