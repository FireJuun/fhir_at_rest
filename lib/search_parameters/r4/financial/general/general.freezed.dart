  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _ChargeItemSearch &&
            ...
            (identical(other.price_override, price_override) || const DeepCollectionEquality().equals(other.price_override, price_override)) &&
    ...
    return identical(this, other) ||
        (other is _ChargeItemDefinitionSearch &&
            ...
            (identical(other.context_type_quantity, context_type_quantity) ||
                const DeepCollectionEquality().equals(other.context_type_quantity, context_type_quantity)) &&
...
class _$_ContractSearch extends _ContractSearch {
  ...
  @override
  String toString() {
    return 'ContractSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, searchHas: $searchHas, searchType: $searchType, authority: $authority, domain: $domain, identifier: $identifier, instantiates: $instantiates, issued: $issued, patient: $patient, signer: $signer, status: $status, subject: $subject, url: $url)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _ExplanationOfBenefitSearch &&
            ...
            (identical(other.procedure_udi, procedure_udi) || const DeepCollectionEquality().equals(other.procedure_udi, procedure_udi)) &&
