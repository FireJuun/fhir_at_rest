...
class _$PaymentNoticeSearchCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      response:
          response == freezed ? _value.response : response as List<String>,
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'PaymentNoticeSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, created: $created, identifier: $identifier, payment_status: $payment_status, provider: $provider, request: $request, response: $response, status: $status)';
  }
...
//List<SearchToken> searchType,
  ...
  List<String> get payment_issuer;
  List<String> get request;
...
//List<SearchToken> searchType,
  ...
  @override
  final List<String> payment_issuer;
  @override
  final List<String> request;
  @override
  ...
  @override
  String toString() {
    return 'PaymentReconciliationSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, created: $created, disposition: $disposition, identifier: $identifier, outcome: $outcome, payment_issuer: $payment_issuer, request: $request, requestor: $requestor, status: $status)';
  }
