...
class _$CompositionSearchCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      attester:
          attester == freezed ? _value.attester : attester as List<String>,
      ...
      entry: entry == freezed ? _value.entry : entry as List<String>,
...
abstract class _DocumentManifestSearch extends DocumentManifestSearch {
  ...
  factory _DocumentManifestSearch(
      ...
      List<SearchUri> source,
      List<SearchToken> status,
      List<String> subject}) = _$_DocumentManifestSearch;
...
//List<SearchToken> searchType,
  ...
  List<SearchToken> get type;
  List<String> get encounter;
  List<String> get authenticator;
  List<String> get author;
  List<SearchToken> get category;
  List<SearchToken> get contenttype;
  List<String> get custodian;
  List<SearchDate> get date;
  List<SearchString> get description;
...
class _$DocumentReferenceSearchCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      custodian:
          custodian == freezed ? _value.custodian : custodian as List<String>,
      date: date == freezed ? _value.date : date as List<SearchDate>,
      description: description == freezed
          ? _value.description
          : description as List<SearchString>,
      ...
      period: period == freezed ? _value.period : period as List<SearchDate>,
      related: related == freezed ? _value.related : related as List<String>,
      relatesto:
          relatesto == freezed ? _value.relatesto : relatesto as List<String>,
      relation:
...
//List<SearchToken> searchType,
  ...
  final List<String> encounter;
  @override
  final List<String> authenticator;
  @override
  final List<String> author;
  @override
  final List<SearchToken> category;
...
abstract class _DocumentReferenceSearch extends DocumentReferenceSearch {
  ...
  factory _DocumentReferenceSearch(
      ...
      List<SearchToken> status,
      List<String> subject,
      List<String> relationship}) = _$_DocumentReferenceSearch;
