...
//List<SearchToken> searchType,
  ...
  List<String> get source_reference;
...
class _$ConsentSearchCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      consentor:
          consentor == freezed ? _value.consentor : consentor as List<String>,
      ...
      source_reference: source_reference == freezed
          ...
          : source_reference as List<String>,
...
class _$AuditEventSearchCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      agent: agent == freezed ? _value.agent : agent as List<String>,
      ...
      date: date == freezed ? _value.date : date as List<SearchDate>,
      entity: entity == freezed ? _value.entity : entity as List<String>,
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'AuditEventSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, action: $action, address: $address, agent: $agent, agent_name: $agent_name, agent_role: $agent_role, altid: $altid, date: $date, entity: $entity, entity_name: $entity_name, entity_role: $entity_role, entity_type: $entity_type, outcome: $outcome, patient: $patient, policy: $policy, site: $site, source: $source, subtype: $subtype, type: $type)';
  }
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'ProvenanceSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, agent: $agent, agent_role: $agent_role, agent_type: $agent_type, entity: $entity, location: $location, patient: $patient, recorded: $recorded, signature_type: $signature_type, target: $target, when: $when)';
  }
