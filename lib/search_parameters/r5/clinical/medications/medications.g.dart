  ...
  return _$_MedicationAdministrationSearch(
    ...
    reasonGiven: (json['reason-given'] as List)
        ?.map((e) => e == null
            ...
            : SearchReference.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    reasonGivencode: (json['reason-given-code'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
Map<String, dynamic> _$_$_MedicationAdministrationSearchToJson(
  ...
  writeNotNull('reason-given-code',
      instance.reasonGivencode?.map((e) => e?.toJson())?.toList());
  ...
  return _$_MedicationRequestSearch(
    ...
    category: (json['category'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    comboDate: (json['combo-date'] as List)
        ?.map((e) =>
            e == null ? null : SearchDate.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
Map<String, dynamic> _$_$_MedicationRequestSearchToJson(
  ...
  writeNotNull(
      'combo-date', instance.comboDate?.map((e) => e?.toJson())?.toList());
...
_$_MedicationUsageSearch _$_$_MedicationUsageSearchFromJson(
    Map<String, dynamic> json) {
  return _$_MedicationUsageSearch(
    searchId: (json['searchId'] as List)
        ?.map((e) => e == null ? null : Id.fromJson(e as String))
        ?.toList(),
    searchLastUpdated: (json['searchLastUpdated'] as List)
    ...
    status: (json['status'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    adherence: (json['adherence'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    category: (json['category'] as List)
...
Map<String, dynamic> _$_$_MedicationUsageSearchToJson(
    _$_MedicationUsageSearch instance) {
  final val = <String, dynamic>{};
  ...
  writeNotNull('status', instance.status?.map((e) => e?.toJson())?.toList());
  writeNotNull(
      'adherence', instance.adherence?.map((e) => e?.toJson())?.toList());
  writeNotNull(
      'category', instance.category?.map((e) => e?.toJson())?.toList());
  writeNotNull(
  ...
  return _$_MedicationKnowledgeSearch(
    ...
    monographType: (json['monograph-type'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    packagingCost: (json['packaging-cost'] as List)
        ?.map((e) => e == null
            ? null
            : SearchQuantity.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    packagingCostconcept: (json['packaging-cost-concept'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    productType: (json['product-type'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
Map<String, dynamic> _$_$_MedicationKnowledgeSearchToJson(
  ...
  writeNotNull('packaging-cost',
      instance.packagingCost?.map((e) => e?.toJson())?.toList());
  writeNotNull('packaging-cost-concept',
      instance.packagingCostconcept?.map((e) => e?.toJson())?.toList());
  writeNotNull(
      'product-type', instance.productType?.map((e) => e?.toJson())?.toList());
  writeNotNull(
