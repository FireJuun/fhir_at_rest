...
@freezed
abstract class ServiceRequestSearch
    with R5SearchParameters
    implements _$ServiceRequestSearch {
...
//List<SearchToken> searchType,
  ...
  factory ServiceRequestSearch.fromJson(Map<String, dynamic> json) =>
      _$ServiceRequestSearchFromJson(json);
}

@freezed
abstract class CarePlanSearch
    with R5SearchParameters
    implements _$CarePlanSearch {
...
//List<SearchToken> searchType,
  ...
  CarePlanSearch._();
  factory CarePlanSearch.fromJson(Map<String, dynamic> json) =>
      _$CarePlanSearchFromJson(json);
}

@freezed
abstract class CareTeamSearch
    with R5SearchParameters
    implements _$CareTeamSearch {
...
//List<SearchToken> searchType,
  ...
  CareTeamSearch._();
  factory CareTeamSearch.fromJson(Map<String, dynamic> json) =>
      _$CareTeamSearchFromJson(json);
}
...
//List<SearchToken> searchType,
  ...
  GoalSearch._();
  factory GoalSearch.fromJson(Map<String, dynamic> json) =>
      _$GoalSearchFromJson(json);
}

@freezed
abstract class NutritionOrderSearch
    with R5SearchParameters
    implements _$NutritionOrderSearch {
...
//List<SearchToken> searchType,
  ...
  factory NutritionOrderSearch.fromJson(Map<String, dynamic> json) =>
      _$NutritionOrderSearchFromJson(json);
}

@freezed
abstract class VisionPrescriptionSearch
    with R5SearchParameters
    implements _$VisionPrescriptionSearch {
...
//List<SearchToken> searchType,
  ...
  factory VisionPrescriptionSearch.fromJson(Map<String, dynamic> json) =>
      _$VisionPrescriptionSearchFromJson(json);
}

@freezed
abstract class NutritionIntakeSearch
    with R5SearchParameters
    implements _$NutritionIntakeSearch {
...
//List<SearchToken> searchType,
  ...
  factory NutritionIntakeSearch.fromJson(Map<String, dynamic> json) =>
      _$NutritionIntakeSearchFromJson(json);
}

@freezed
abstract class RequestGroupSearch
    with R5SearchParameters
    implements _$RequestGroupSearch {
...
//List<SearchToken> searchType,
  ...
  factory RequestGroupSearch.fromJson(Map<String, dynamic> json) =>
      _$RequestGroupSearchFromJson(json);
}
