...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'AdverseEventSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, actuality: $actuality, category: $category, code: $code, date: $date, identifier: $identifier, location: $location, patient: $patient, recorder: $recorder, resultingcondition: $resultingcondition, seriousness: $seriousness, status: $status, study: $study, subject: $subject, substance: $substance)';
  }
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'ClinicalImpressionSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, date: $date, patient: $patient, encounter: $encounter, findingCode: $findingCode, findingRef: $findingRef, identifier: $identifier, performer: $performer, previous: $previous, problem: $problem, status: $status, subject: $subject, supportingInfo: $supportingInfo)';
  }
