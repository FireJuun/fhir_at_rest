...
// ignore: unused_element
  _EncounterSearch call(
      ...
      List<SearchToken> status,
      List<SearchReference> subject,
      @JsonKey(name: 'subject-status')
          List<SearchToken> subjectStatus}) {
...
//List<SearchToken> searchType,
  ...
  List<SearchReference> get subject;
  @JsonKey(name: 'subject-status')
  List<SearchToken> get subjectStatus;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      subjectStatus: subjectStatus == freezed
          ...
          : subjectStatus as List<SearchToken>,
    ));
  }
}
...
class _$_EncounterSearch extends _EncounterSearch {
  _$_EncounterSearch(
      ...
      this.status,
      this.subject,
      @JsonKey(name: 'subject-status') this.subjectStatus})
      : super._();
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _EncounterSearch &&
            ...
            (identical(other.subjectStatus, subjectStatus) || const DeepCollectionEquality().equals(other.subjectStatus, subjectStatus)));
  }
...
abstract class _EncounterSearch extends EncounterSearch {
  ...
  factory _EncounterSearch(
      ...
      List<SearchReference> subject,
      @JsonKey(name: 'subject-status')
          List<SearchToken> subjectStatus}) = _$_EncounterSearch;
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'FlagSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, date: $date, patient: $patient, encounter: $encounter, author: $author, identifier: $identifier, status: $status, subject: $subject)';
  }
