...
//List<SearchToken> searchType,
  ...
  List<SearchReference> get controller;
  List<SearchReference> get data;
  List<SearchReference> get manager;
  List<SearchDate> get period;
  @JsonKey(name: 'policy-uri')
  List<SearchUri> get policyUri;
  ...
  List<SearchToken> get verified;
  @JsonKey(name: 'verified-date')
  List<SearchDate> get verifiedDate;
...
class _$ConsentSearchCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      verified:
          verified == freezed ? _value.verified : verified as List<SearchToken>,
      verifiedDate: verifiedDate == freezed
          ? _value.verifiedDate
          : verifiedDate as List<SearchDate>,
    ));
  }
}
...
class _$_ConsentSearch extends _ConsentSearch {
  _$_ConsentSearch(
      ...
      this.manager,
      this.period,
      @JsonKey(name: 'policy-uri') this.policyUri,
      this.purpose,
      this.scope,
      ...
      this.subject,
      this.verified,
      @JsonKey(name: 'verified-date') this.verifiedDate})
      : super._();
...
//List<SearchToken> searchType,
  ...
  @override
  final List<SearchReference> controller;
  @override
  final List<SearchReference> data;
  @override
  final List<SearchReference> manager;
  @override
  final List<SearchDate> period;
  @override
  @JsonKey(name: 'policy-uri')
  final List<SearchUri> policyUri;
  @override
  ...
  @override
  final List<SearchToken> verified;
  @override
  @JsonKey(name: 'verified-date')
  final List<SearchDate> verifiedDate;

  @override
  String toString() {
    return 'ConsentSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, date: $date, identifier: $identifier, patient: $patient, action: $action, actor: $actor, category: $category, consentor: $consentor, controller: $controller, data: $data, manager: $manager, period: $period, policyUri: $policyUri, purpose: $purpose, scope: $scope, securityLabel: $securityLabel, sourceReference: $sourceReference, status: $status, subject: $subject, verified: $verified, verifiedDate: $verifiedDate)';
  }
    ...
    return identical(this, other) ||
        (other is _ConsentSearch &&
            ...
            (identical(other.policyUri, policyUri) ||
                const DeepCollectionEquality()
                    .equals(other.policyUri, policyUri)) &&
            ...
            (identical(other.verified, verified) || const DeepCollectionEquality().equals(other.verified, verified)) &&
            (identical(other.verifiedDate, verifiedDate) || const DeepCollectionEquality().equals(other.verifiedDate, verifiedDate)));
  }
...
abstract class _ConsentSearch extends ConsentSearch {
  ...
  factory _ConsentSearch(
      ...
      List<SearchDate> period,
      @JsonKey(name: 'policy-uri')
          List<SearchUri> policyUri,
      List<SearchToken> purpose,
      List<SearchToken> scope,
      @JsonKey(name: 'security-label')
          List<SearchToken> securityLabel,
      @JsonKey(name: 'source-reference')
          List<SearchReference> sourceReference,
      List<SearchToken> status,
      List<SearchReference> subject,
      List<SearchToken> verified,
      @JsonKey(name: 'verified-date')
          List<SearchDate> verifiedDate}) = _$_ConsentSearch;
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'AuditEventSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, action: $action, address: $address, agent: $agent, agentName: $agentName, agentRole: $agentRole, altid: $altid, date: $date, entity: $entity, entityName: $entityName, entityRole: $entityRole, entityType: $entityType, outcome: $outcome, patient: $patient, policy: $policy, purpose: $purpose, site: $site, source: $source, subtype: $subtype, type: $type)';
  }
...
PermissionSearch _$PermissionSearchFromJson(Map<String, dynamic> json) {
  return _PermissionSearch.fromJson(json);
}

/// @nodoc
class _$PermissionSearchTearOff {
  const _$PermissionSearchTearOff();

// ignore: unused_element
  _PermissionSearch call(
      {List<Id> searchId,
      List<SearchDate> searchLastUpdated,
      List<SearchToken> searchTag,
      List<SearchUri> searchProfile,
...
// ignore: unused_element
  PermissionSearch fromJson(Map<String, Object> json) {
    return PermissionSearch.fromJson(json);
  }
}

/// @nodoc
// ignore: unused_element
const $PermissionSearch = _$PermissionSearchTearOff();

/// @nodoc
mixin _$PermissionSearch {
  List<Id> get searchId;
  List<SearchDate> get searchLastUpdated;
  List<SearchToken> get searchTag;
  List<SearchUri> get searchProfile;
...
//List<SearchToken> searchType,
  ...
  Map<String, dynamic> toJson();
  $PermissionSearchCopyWith<PermissionSearch> get copyWith;
}

/// @nodoc
abstract class $PermissionSearchCopyWith<$Res> {
  factory $PermissionSearchCopyWith(
          PermissionSearch value, $Res Function(PermissionSearch) then) =
      _$PermissionSearchCopyWithImpl<$Res>;
  $Res call(
      {List<Id> searchId,
      List<SearchDate> searchLastUpdated,
      List<SearchToken> searchTag,
...
/// @nodoc
class _$PermissionSearchCopyWithImpl<$Res>
    implements $PermissionSearchCopyWith<$Res> {
  _$PermissionSearchCopyWithImpl(this._value, this._then);

  final PermissionSearch _value;
  // ignore: unused_field
  final $Res Function(PermissionSearch) _then;
...
/// @nodoc
abstract class _$PermissionSearchCopyWith<$Res>
    implements $PermissionSearchCopyWith<$Res> {
  factory _$PermissionSearchCopyWith(
          _PermissionSearch value, $Res Function(_PermissionSearch) then) =
      __$PermissionSearchCopyWithImpl<$Res>;
  @override
  $Res call(
      {List<Id> searchId,
      List<SearchDate> searchLastUpdated,
...
/// @nodoc
class __$PermissionSearchCopyWithImpl<$Res>
    extends _$PermissionSearchCopyWithImpl<$Res>
    implements _$PermissionSearchCopyWith<$Res> {
  __$PermissionSearchCopyWithImpl(
      _PermissionSearch _value, $Res Function(_PermissionSearch) _then)
      : super(_value, (v) => _then(v as _PermissionSearch));

  @override
  _PermissionSearch get _value => super._value as _PermissionSearch;
  ...
  $Res call({
    ...
    return _then(_PermissionSearch(
      searchId: searchId == freezed ? _value.searchId : searchId as List<Id>,
      searchLastUpdated: searchLastUpdated == freezed
          ? _value.searchLastUpdated
          : searchLastUpdated as List<SearchDate>,
...
/// @nodoc
class _$_PermissionSearch extends _PermissionSearch {
  _$_PermissionSearch(
      {this.searchId,
      this.searchLastUpdated,
      this.searchTag,
  ...
  factory _$_PermissionSearch.fromJson(Map<String, dynamic> json) =>
      _$_$_PermissionSearchFromJson(json);
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'PermissionSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, status: $status)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _PermissionSearch &&
            (identical(other.searchId, searchId) ||
                const DeepCollectionEquality()
                    .equals(other.searchId, searchId)) &&
            (identical(other.searchLastUpdated, searchLastUpdated) ||
  ...
  @override
  _$PermissionSearchCopyWith<_PermissionSearch> get copyWith =>
      __$PermissionSearchCopyWithImpl<_PermissionSearch>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$_$_PermissionSearchToJson(this);
  }
}

abstract class _PermissionSearch extends PermissionSearch {
  _PermissionSearch._() : super._();
  factory _PermissionSearch(
      {List<Id> searchId,
      List<SearchDate> searchLastUpdated,
      List<SearchToken> searchTag,
      List<SearchUri> searchProfile,
      ...
      List<SearchString> searchContent,
      List<Id> searchList,
      List<SearchToken> status}) = _$_PermissionSearch;

  factory _PermissionSearch.fromJson(Map<String, dynamic> json) =
      _$_PermissionSearch.fromJson;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      searchList:
          searchList == freezed ? _value.searchList : searchList as List<Id>,
      activity:
          activity == freezed ? _value.activity : activity as List<SearchToken>,
      agent: agent == freezed ? _value.agent : agent as List<SearchReference>,
      agentRole: agentRole == freezed
          ? _value.agentRole
          : agentRole as List<SearchToken>,
...
class _$_ProvenanceSearch extends _ProvenanceSearch {
  ...
  @override //List<SearchString> searchHas,
//List<SearchToken> searchType,
  final List<SearchToken> activity;
  @override
  final List<SearchReference> agent;
  @override
  @JsonKey(name: 'agent-role')
