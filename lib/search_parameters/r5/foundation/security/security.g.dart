  ...
  return _$_ConsentSearch(
    ...
    period: (json['period'] as List)
        ?.map((e) =>
            e == null ? null : SearchDate.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    policyUri: (json['policy-uri'] as List)
        ?.map((e) =>
            e == null ? null : SearchUri.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    ...
    verified: (json['verified'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    verifiedDate: (json['verified-date'] as List)
        ?.map((e) =>
            e == null ? null : SearchDate.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
...
Map<String, dynamic> _$_$_ConsentSearchToJson(_$_ConsentSearch instance) {
  ...
  writeNotNull(
      'policy-uri', instance.policyUri?.map((e) => e?.toJson())?.toList());
  ...
  writeNotNull('source-reference',
      instance.sourceReference?.map((e) => e?.toJson())?.toList());
  writeNotNull('status', instance.status?.map((e) => e?.toJson())?.toList());
  writeNotNull('subject', instance.subject?.map((e) => e?.toJson())?.toList());
  writeNotNull(
      'verified', instance.verified?.map((e) => e?.toJson())?.toList());
  writeNotNull('verified-date',
      instance.verifiedDate?.map((e) => e?.toJson())?.toList());
  return val;
}
...
_$_PermissionSearch _$_$_PermissionSearchFromJson(Map<String, dynamic> json) {
  return _$_PermissionSearch(
    searchId: (json['searchId'] as List)
        ?.map((e) => e == null ? null : Id.fromJson(e as String))
        ?.toList(),
    searchLastUpdated: (json['searchLastUpdated'] as List)
...
Map<String, dynamic> _$_$_PermissionSearchToJson(_$_PermissionSearch instance) {
  final val = <String, dynamic>{};
