  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      supplements: supplements == freezed
          ? _value.supplements
          : supplements as List<SearchReference>,
...
//List<SearchToken> searchType,
  ...
  @override
  final List<SearchReference> supplements;
  @override
...
class _$ConceptMapSearchCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      other: other == freezed ? _value.other : other as List<SearchReference>,
...
//List<SearchToken> searchType,
  ...
  @override
  final List<SearchReference> other;
  @override
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'NamingSystemSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, context: $context, contextQuantity: $contextQuantity, contextType: $contextType, date: $date, description: $description, jurisdiction: $jurisdiction, name: $name, publisher: $publisher, status: $status, url: $url, version: $version, contextTypequantity: $contextTypequantity, contextTypevalue: $contextTypevalue, contact: $contact, idType: $idType, kind: $kind, period: $period, responsible: $responsible, telecom: $telecom, type: $type, value: $value)';
  }
...
abstract class _TerminologyCapabilitiesSearch
  ...
  factory _TerminologyCapabilitiesSearch(
      ...
      @JsonKey(name: 'context-type-value')
          List<SearchComposite> contextTypevalue,
      List<SearchToken> identifier}) = _$_TerminologyCapabilitiesSearch;
