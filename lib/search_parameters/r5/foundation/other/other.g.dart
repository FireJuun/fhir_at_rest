...
Map<String, dynamic> _$_$_BundleSearchToJson(_$_BundleSearch instance) {
  ...
  writeNotNull(
      'identifier', instance.identifier?.map((e) => e?.toJson())?.toList());
  writeNotNull('message', instance.message?.map((e) => e?.toJson())?.toList());
  writeNotNull(
...
_$_SubscriptionTopicSearch _$_$_SubscriptionTopicSearchFromJson(
    Map<String, dynamic> json) {
  return _$_SubscriptionTopicSearch(
    searchId: (json['searchId'] as List)
        ?.map((e) => e == null ? null : Id.fromJson(e as String))
        ?.toList(),
    searchLastUpdated: (json['searchLastUpdated'] as List)
    ...
    date: (json['date'] as List)
        ?.map((e) =>
            e == null ? null : SearchDate.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    derivedOrself: (json['derived-or-self'] as List)
        ?.map((e) =>
            e == null ? null : SearchUri.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    identifier: (json['identifier'] as List)
    ...
    publisher: (json['publisher'] as List)
        ?.map((e) => e == null
            ...
            : SearchReference.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    resourceType: (json['resource-type'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    status: (json['status'] as List)
    ...
    title: (json['title'] as List)
        ?.map((e) =>
            e == null ? null : SearchString.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    triggerDescription: (json['trigger-description'] as List)
        ?.map((e) =>
            e == null ? null : SearchString.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    url: (json['url'] as List)
...
Map<String, dynamic> _$_$_SubscriptionTopicSearchToJson(
    _$_SubscriptionTopicSearch instance) {
  final val = <String, dynamic>{};
  ...
  writeNotNull('derived-or-self',
      instance.derivedOrself?.map((e) => e?.toJson())?.toList());
  writeNotNull(
      'identifier', instance.identifier?.map((e) => e?.toJson())?.toList());
  writeNotNull(
      'publisher', instance.publisher?.map((e) => e?.toJson())?.toList());
  writeNotNull('resource-type',
      instance.resourceType?.map((e) => e?.toJson())?.toList());
  writeNotNull('status', instance.status?.map((e) => e?.toJson())?.toList());
  writeNotNull('title', instance.title?.map((e) => e?.toJson())?.toList());
  writeNotNull('trigger-description',
