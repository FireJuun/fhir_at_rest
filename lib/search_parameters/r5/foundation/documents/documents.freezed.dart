...
//List<SearchToken> searchType,
  ...
  List<SearchDate> get creation;
  List<SearchReference> get custodian;
  List<SearchDate> get date;
  List<SearchString> get description;
  @JsonKey(name: 'doc-status')
  List<SearchToken> get docStatus;
...
class _$DocumentReferenceSearchCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      creation:
          creation == freezed ? _value.creation : creation as List<SearchDate>,
...
class _$_DocumentReferenceSearch extends _DocumentReferenceSearch {
  _$_DocumentReferenceSearch(
      ...
      this.date,
      this.description,
      @JsonKey(name: 'doc-status') this.docStatus,
      this.event,
      this.facility,
      this.format,
      this.language,
...
//List<SearchToken> searchType,
  ...
  @override
  final List<SearchDate> creation;
  @override
  ...
  @override
  @JsonKey(name: 'doc-status')
  final List<SearchToken> docStatus;
  @override
  ...
  @override
  String toString() {
    return 'DocumentReferenceSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, identifier: $identifier, patient: $patient, type: $type, encounter: $encounter, attester: $attester, author: $author, basedOn: $basedOn, category: $category, contenttype: $contenttype, creation: $creation, custodian: $custodian, date: $date, description: $description, docStatus: $docStatus, event: $event, facility: $facility, format: $format, language: $language, location: $location, period: $period, related: $related, relatesto: $relatesto, relation: $relation, securityLabel: $securityLabel, setting: $setting, status: $status, subject: $subject, relationship: $relationship)';
  }
...
CatalogEntrySearch _$CatalogEntrySearchFromJson(Map<String, dynamic> json) {
  return _CatalogEntrySearch.fromJson(json);
}

/// @nodoc
class _$CatalogEntrySearchTearOff {
  const _$CatalogEntrySearchTearOff();

// ignore: unused_element
  _CatalogEntrySearch call(
      {List<Id> searchId,
      List<SearchDate> searchLastUpdated,
      List<SearchToken> searchTag,
      List<SearchUri> searchProfile,
...
// ignore: unused_element
  CatalogEntrySearch fromJson(Map<String, Object> json) {
    return CatalogEntrySearch.fromJson(json);
  }
}

/// @nodoc
// ignore: unused_element
const $CatalogEntrySearch = _$CatalogEntrySearchTearOff();

/// @nodoc
mixin _$CatalogEntrySearch {
  List<Id> get searchId;
  List<SearchDate> get searchLastUpdated;
  List<SearchToken> get searchTag;
  List<SearchUri> get searchProfile;
...
//List<SearchToken> searchType,
  ...
  List<SearchToken> get orderable;
  @JsonKey(name: 'referenced-item')
  List<SearchReference> get referencedItem;
  @JsonKey(name: 'related-entry')
  List<SearchReference> get relatedEntry;
  List<SearchToken> get status;
  List<SearchToken> get type;

  Map<String, dynamic> toJson();
  $CatalogEntrySearchCopyWith<CatalogEntrySearch> get copyWith;
}

/// @nodoc
abstract class $CatalogEntrySearchCopyWith<$Res> {
  factory $CatalogEntrySearchCopyWith(
          CatalogEntrySearch value, $Res Function(CatalogEntrySearch) then) =
      _$CatalogEntrySearchCopyWithImpl<$Res>;
  $Res call(
      {List<Id> searchId,
      List<SearchDate> searchLastUpdated,
      List<SearchToken> searchTag,
...
/// @nodoc
class _$CatalogEntrySearchCopyWithImpl<$Res>
    implements $CatalogEntrySearchCopyWith<$Res> {
  _$CatalogEntrySearchCopyWithImpl(this._value, this._then);

  final CatalogEntrySearch _value;
  // ignore: unused_field
  final $Res Function(CatalogEntrySearch) _then;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      orderable: orderable == freezed
          ? _value.orderable
          : orderable as List<SearchToken>,
      referencedItem: referencedItem == freezed
          ? _value.referencedItem
          : referencedItem as List<SearchReference>,
      relatedEntry: relatedEntry == freezed
          ? _value.relatedEntry
          : relatedEntry as List<SearchReference>,
      status: status == freezed ? _value.status : status as List<SearchToken>,
      type: type == freezed ? _value.type : type as List<SearchToken>,
    ));
  }
...
/// @nodoc
abstract class _$CatalogEntrySearchCopyWith<$Res>
    implements $CatalogEntrySearchCopyWith<$Res> {
  factory _$CatalogEntrySearchCopyWith(
          _CatalogEntrySearch value, $Res Function(_CatalogEntrySearch) then) =
      __$CatalogEntrySearchCopyWithImpl<$Res>;
  @override
  $Res call(
      {List<Id> searchId,
      List<SearchDate> searchLastUpdated,
...
/// @nodoc
class __$CatalogEntrySearchCopyWithImpl<$Res>
    extends _$CatalogEntrySearchCopyWithImpl<$Res>
    implements _$CatalogEntrySearchCopyWith<$Res> {
  __$CatalogEntrySearchCopyWithImpl(
      _CatalogEntrySearch _value, $Res Function(_CatalogEntrySearch) _then)
      : super(_value, (v) => _then(v as _CatalogEntrySearch));

  @override
  _CatalogEntrySearch get _value => super._value as _CatalogEntrySearch;
  ...
  $Res call({
    ...
    return _then(_CatalogEntrySearch(
      searchId: searchId == freezed ? _value.searchId : searchId as List<Id>,
      searchLastUpdated: searchLastUpdated == freezed
          ? _value.searchLastUpdated
          : searchLastUpdated as List<SearchDate>,
...
/// @nodoc
class _$_CatalogEntrySearch extends _CatalogEntrySearch {
  _$_CatalogEntrySearch(
      {this.searchId,
      this.searchLastUpdated,
      this.searchTag,
      this.searchProfile,
      ...
      this.name,
      this.orderable,
      @JsonKey(name: 'referenced-item') this.referencedItem,
      @JsonKey(name: 'related-entry') this.relatedEntry,
      this.status,
      this.type})
      : super._();

  factory _$_CatalogEntrySearch.fromJson(Map<String, dynamic> json) =>
      _$_$_CatalogEntrySearchFromJson(json);
...
//List<SearchToken> searchType,
  ...
  @override
  final List<SearchToken> orderable;
  @override
  @JsonKey(name: 'referenced-item')
  final List<SearchReference> referencedItem;
  @override
  @JsonKey(name: 'related-entry')
  final List<SearchReference> relatedEntry;
  @override
  final List<SearchToken> status;
  @override
  final List<SearchToken> type;
  ...
  @override
  String toString() {
    return 'CatalogEntrySearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, identifier: $identifier, name: $name, orderable: $orderable, referencedItem: $referencedItem, relatedEntry: $relatedEntry, status: $status, type: $type)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _CatalogEntrySearch &&
            (identical(other.searchId, searchId) ||
                const DeepCollectionEquality()
                    .equals(other.searchId, searchId)) &&
            (identical(other.searchLastUpdated, searchLastUpdated) ||
  ...
  @override
  _$CatalogEntrySearchCopyWith<_CatalogEntrySearch> get copyWith =>
      __$CatalogEntrySearchCopyWithImpl<_CatalogEntrySearch>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$_$_CatalogEntrySearchToJson(this);
  }
}

abstract class _CatalogEntrySearch extends CatalogEntrySearch {
  _CatalogEntrySearch._() : super._();
  factory _CatalogEntrySearch(
      {List<Id> searchId,
      List<SearchDate> searchLastUpdated,
      List<SearchToken> searchTag,
      List<SearchUri> searchProfile,
      ...
      @JsonKey(name: 'related-entry') List<SearchReference> relatedEntry,
      List<SearchToken> status,
      List<SearchToken> type}) = _$_CatalogEntrySearch;

  factory _CatalogEntrySearch.fromJson(Map<String, dynamic> json) =
      _$_CatalogEntrySearch.fromJson;
