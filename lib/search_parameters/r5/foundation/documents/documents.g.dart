  ...
  return _$_DocumentReferenceSearch(
    ...
    contenttype: (json['contenttype'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    creation: (json['creation'] as List)
        ?.map((e) =>
            e == null ? null : SearchDate.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    ...
    description: (json['description'] as List)
        ?.map((e) =>
            e == null ? null : SearchString.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    docStatus: (json['doc-status'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
Map<String, dynamic> _$_$_DocumentReferenceSearchToJson(
  ...
  writeNotNull(
      'creation', instance.creation?.map((e) => e?.toJson())?.toList());
  writeNotNull(
  ...
  writeNotNull(
      'description', instance.description?.map((e) => e?.toJson())?.toList());
  writeNotNull(
      'doc-status', instance.docStatus?.map((e) => e?.toJson())?.toList());
...
_$_CatalogEntrySearch _$_$_CatalogEntrySearchFromJson(
    Map<String, dynamic> json) {
  return _$_CatalogEntrySearch(
    searchId: (json['searchId'] as List)
        ?.map((e) => e == null ? null : Id.fromJson(e as String))
        ?.toList(),
    searchLastUpdated: (json['searchLastUpdated'] as List)
    ...
    name: (json['name'] as List)
        ?.map((e) =>
            e == null ? null : SearchString.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    orderable: (json['orderable'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    referencedItem: (json['referenced-item'] as List)
        ?.map((e) => e == null
            ? null
            : SearchReference.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    relatedEntry: (json['related-entry'] as List)
        ?.map((e) => e == null
            ? null
            : SearchReference.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
Map<String, dynamic> _$_$_CatalogEntrySearchToJson(
    _$_CatalogEntrySearch instance) {
  final val = <String, dynamic>{};
  ...
  writeNotNull(
      'orderable', instance.orderable?.map((e) => e?.toJson())?.toList());
  writeNotNull('referenced-item',
      instance.referencedItem?.map((e) => e?.toJson())?.toList());
  writeNotNull('related-entry',
      instance.relatedEntry?.map((e) => e?.toJson())?.toList());
  writeNotNull('status', instance.status?.map((e) => e?.toJson())?.toList());
  writeNotNull('type', instance.type?.map((e) => e?.toJson())?.toList());
  return val;
}
