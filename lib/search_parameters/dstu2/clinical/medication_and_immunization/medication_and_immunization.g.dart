  ...
  return _$_MedicationDispenseSearch(
    ...
    destination: (json['destination'] as List)
        ?.map((e) => e == null
            ...
            : SearchReference.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    dispenser: (json['dispenser'] as List)
        ?.map((e) => e == null
            ? null
            : SearchReference.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
Map<String, dynamic> _$_$_MedicationDispenseSearchToJson(
  ...
  writeNotNull(
      'dispenser', instance.dispenser?.map((e) => e?.toJson())?.toList());
  writeNotNull(
      'identifier', instance.identifier?.map((e) => e?.toJson())?.toList());
  writeNotNull(
  ...
  return _$_MedicationAdministrationSearch(
    ...
    device: (json['device'] as List)
        ?.map((e) => e == null
            ...
            : SearchReference.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    effectivetime: (json['effectivetime'] as List)
        ?.map((e) =>
            e == null ? null : SearchDate.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
_$_MedicationOrderSearch _$_$_MedicationOrderSearchFromJson(
    Map<String, dynamic> json) {
  return _$_MedicationOrderSearch(
    searchId: (json['searchId'] as List)
        ?.map((e) => e == null ? null : Id.fromJson(e as String))
        ?.toList(),
    searchLastUpdated: (json['searchLastUpdated'] as List)
...
Map<String, dynamic> _$_$_MedicationOrderSearchToJson(
    _$_MedicationOrderSearch instance) {
  final val = <String, dynamic>{};
