  ...
  return _$_ConditionSearch(
    ...
    category: (json['category'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    clinicalstatus: (json['clinicalstatus'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    code: (json['code'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    dateRecorded: (json['date-recorded'] as List)
        ?.map((e) =>
            e == null ? null : SearchDate.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
Map<String, dynamic> _$_$_ConditionSearchToJson(_$_ConditionSearch instance) {
  ...
  writeNotNull('date-recorded',
      instance.dateRecorded?.map((e) => e?.toJson())?.toList());
  writeNotNull(
  ...
  return _$_ClinicalImpressionSearch(
    ...
    trigger: (json['trigger'] as List)
        ?.map((e) => e == null
            ...
            : SearchReference.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    triggerCode: (json['trigger-code'] as List)
        ?.map((e) =>
            e == null ? null : SearchToken.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
...
Map<String, dynamic> _$_$_ClinicalImpressionSearchToJson(
  ...
  writeNotNull(
      'trigger-code', instance.triggerCode?.map((e) => e?.toJson())?.toList());
  return val;
}
