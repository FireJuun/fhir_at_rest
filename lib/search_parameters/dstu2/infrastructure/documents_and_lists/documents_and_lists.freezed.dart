...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'CompositionSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, attester: $attester, author: $author, class_: $class_, confidentiality: $confidentiality, context: $context, date: $date, encounter: $encounter, entry: $entry, identifier: $identifier, patient: $patient, period: $period, section: $section, status: $status, subject: $subject, title: $title, type: $type)';
  }
...
abstract class _CompositionSearch extends CompositionSearch {
  ...
  factory _CompositionSearch(
      ...
      List<SearchReference> subject,
      List<SearchString> title,
      List<SearchToken> type}) = _$_CompositionSearch;
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'DocumentReferenceSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, authenticator: $authenticator, author: $author, class_: $class_, created: $created, custodian: $custodian, description: $description, encounter: $encounter, event: $event, facility: $facility, format: $format, identifier: $identifier, indexed: $indexed, language: $language, location: $location, patient: $patient, period: $period, relatedId: $relatedId, relatedRef: $relatedRef, relatesto: $relatesto, relation: $relation, relationship: $relationship, securitylabel: $securitylabel, setting: $setting, status: $status, subject: $subject, type: $type)';
  }
...
abstract class _DocumentReferenceSearch extends DocumentReferenceSearch {
  ...
  factory _DocumentReferenceSearch(
      ...
      List<SearchToken> status,
      List<SearchReference> subject,
      List<SearchToken> type}) = _$_DocumentReferenceSearch;
...
//List<SearchToken> searchType,
  ...
  @override
  String toString() {
    return 'DocumentManifestSearch(searchId: $searchId, searchLastUpdated: $searchLastUpdated, searchTag: $searchTag, searchProfile: $searchProfile, searchSecurity: $searchSecurity, searchText: $searchText, searchContent: $searchContent, searchList: $searchList, author: $author, contentRef: $contentRef, created: $created, description: $description, identifier: $identifier, patient: $patient, recipient: $recipient, relatedId: $relatedId, relatedRef: $relatedRef, source: $source, status: $status, subject: $subject, type: $type)';
  }
...
abstract class _DocumentManifestSearch extends DocumentManifestSearch {
  ...
  factory _DocumentManifestSearch(
      ...
      List<SearchToken> status,
      List<SearchReference> subject,
      List<SearchToken> type}) = _$_DocumentManifestSearch;
