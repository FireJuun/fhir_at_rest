  ...
  return _$_ProcessResponseSearch(
    ...
    request: (json['request'] as List)
        ?.map((e) => e == null
            ...
            : SearchReference.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    requestorganization: (json['requestorganization'] as List)
        ?.map((e) => e == null
            ? null
            : SearchReference.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    requestprovider: (json['requestprovider'] as List)
        ?.map((e) => e == null
            ? null
            : SearchReference.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
Map<String, dynamic> _$_$_ProcessResponseSearchToJson(
  ...
  writeNotNull('requestorganization',
      instance.requestorganization?.map((e) => e?.toJson())?.toList());
  writeNotNull('requestprovider',
