...
@freezed
abstract class ImplementationGuideSearch with Dstu2SearchParameters implements _$ImplementationGuideSearch {
...
@freezed
abstract class TestScriptSearch with Dstu2SearchParameters implements _$TestScriptSearch {
...
@JsonKey(name: 'testscript-setup-capability') List<SearchString> testscriptSetupcapability,
@JsonKey(name: 'testscript-test-capability') List<SearchString> testscriptTestcapability,
List<SearchUri> url,
}) = _TestScriptSearch;
